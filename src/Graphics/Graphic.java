...
public class Graphic extends JFrame{
	...
	private void init(){
		...
		int vindexN3 = isSupported(1920, 1080, 32, dms); // 2560, 1440 for monitor (At home). 1920,1080 only for turning in projects. Check system-display for resolution if app does not open.
